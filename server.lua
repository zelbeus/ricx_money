...
AddEventHandler("RegisterUsableItem:money5", function(source)
	local _source = source
...
AddEventHandler("RegisterUsableItem:money10", function(source)
	local _source = source
...
AddEventHandler("RegisterUsableItem:money50", function(source)
	local _source = source
...
AddEventHandler("RegisterUsableItem:money100", function(source)
	local _source = source
...
AddEventHandler("RegisterUsableItem:money200", function(source)
	local _source = source
...
AddEventHandler("RegisterUsableItem:money500", function(source)
	local _source = source
